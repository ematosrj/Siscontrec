  ...
  <div class="container">
    ...
    <div class="container2">
      <form class="form1">
        ...
        <input type="text" name="matricula" id="matricula" placeholder="Matrícula" autocomplete="off">
        ...
        <input type="text" name="opm" id="opm" placeholder="OPM" autocomplete="off"> 
...
<footer class="fixar"><br>
  <p>Departamento de Modernização e Tecnologia (DMT)</p>
  <p>Sisconv - Controle de Visitantes</p>
